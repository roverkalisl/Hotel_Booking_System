...
# SIMPLIFIED MODELS - Only essential columns
...
class Hotel(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    is_approved = db.Column(db.Boolean, default=True)  # Simple approval
...
# Database initialization - FORCE NEW DATABASE
def init_db():
    with app.app_context():
        ...
        if not User.query.filter_by(username='superadmin').first():
            ...
            sample_hotel = Hotel(
                name='Sample Hotel Colombo',
                location='Colombo, Sri Lanka',
                description='A beautiful hotel in the heart of Colombo',
            ...
            db.session.add(sample_hotel)
            
            db.session.commit()
            print("✅ NEW Database created successfully!")
            print("✅ Super admin created!")
            print("✅ Sample hotel added!")
        ...
        <body>
            ...
            <div class="container mt-5">
                <div class="alert alert-success">
                    ...
                    <p>Hotels found: {len(hotels) if 'hotels' in locals() else 'N/A'}</p>
                </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/book/{hotel.id}" class="btn btn-primary">Book Now</a>
                    </div>
                </div>
            </div>
            """
        ...
        <body>
            <div class="container mt-5">
                <div class="alert alert-danger">
                    ...
                    <p>Error loading hotels: {str(e)}</p>
...
if __name__ == '__main__':
    ...
    print("🏨 Sample hotel added for testing")
